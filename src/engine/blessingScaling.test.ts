...
describe('scaleBlessingEffects', () => {
  ...
  it('preserves sign for a negated ("reduces damage") linked effect', () => {
    const b = blessingById.get('Headwind')!;
    ...
    expect(rank11.value).toBeLessThan(rank1.value); // more reduction at a higher rank
  });
